<?php
namespace CiscoSystems\SalesForceBundle\ForceToolkit\Test\Soap\Client;

use
    CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Client\PartnerClient,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Client\Connection\SfdcConnection,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Base\login,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Sobject
;
...
{
    /**
     * @return \CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Client\Connection\SfdcConnection
     */
    ...
    /**
     * @return \CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Client\APIInterface
     */
    ...
    public function testConnection()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Base\LoginResult', $connection->getLoginResult());
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Base\login', $connection->getCredentials());
    }
    ...
    public function testConnectionInputHeaders()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Header\SessionHeader', $headers[0]);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Header\CallOptions', $headers[1]);
    ...
    public function testDML()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResult', $createResponse);
        $this->assertNotEmpty(true, $createResponse->get('result'));
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResultCollection', $createResponse->get('result'));
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResult', $updateResponse);
        $this->assertNotEmpty(true, $updateResponse->get('result'));
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResultCollection', $updateResponse->get('result'));
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResult', $deleteResponse);
        $this->assertNotEmpty(true, $deleteResponse->get('result'));
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResultCollection', $deleteResponse->get('result'));
    ...
    public function testReUpdateDML()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\QueryResult', $queryResponse->result);
        $this->assertEquals(1, $queryResponse->result->getSize());
        $toUpdate = $queryResponse->result->getRecords()->get(0);

        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Sobject', $toUpdate);
    ...
    public function testCreateSobjectNegative()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Client\DMLException', $exThrown);
    }
    ...
    public function testDescribeSobject()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResult', $response);
        $this->assertNotEmpty($response->get('result'));
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\DescribeSObjectResult', $response->get('result'));
    }
    ...
    public function testDescribeLayout()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResult', $response);
        $this->assertNotEmpty($response->get('result'));
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\DescribeLayoutResult', $response->get('result'));
    }
    ...
    public function testQuery()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResult', $queryResponse);
        $this->assertNotEmpty($queryResponse->get('result'));
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\QueryResult', $queryResponse->get('result'));
        $this->assertNotCount(0, $queryResponse->get('result')->getRecords());
        $this->assertEquals(1, $queryResponse->get('result')->getSize());
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\SobjectInterface', $queryResponse->get('result')->getRecords()->get(0));
    ...
    public function testQueryNegative()
    {
        ...
        $this->assertNotNull($exThrown);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Client\Connection\TracedSoapFault', $exThrown);
    ...
    public function testQueryMore()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Type\QueryLocator', $queryLocator);
