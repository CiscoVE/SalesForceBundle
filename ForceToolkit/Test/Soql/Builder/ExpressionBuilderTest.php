<?php
namespace CiscoSystems\SalesForceBundle\ForceToolkit\Test\Soql\Builder;

use
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Builder\ExpressionBuilder,
...
class ExpressionBuilderTest extends \PHPUnit_Framework_TestCase
{
    public function testBuilder()
    {
        ...
        /** @var $expression \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalGroup */
        $expression = $builder->getExpression();

        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalGroup', $expression);

        $junctions = $expression->getJunctions();
        $this->assertCount(3, $junctions);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalJunction', $junctions[0]);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalJunction', $junctions[1]);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalJunction', $junctions[2]);
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalCondition', $conditions[0]);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalCondition', $conditions[1]);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalGroup', $conditions[2]);
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\WhereField', $conditions[0]->getLeft());
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\WhereField', $conditions[1]->getLeft());
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\Subquery', $conditions[1]->getRight());
    }
}
