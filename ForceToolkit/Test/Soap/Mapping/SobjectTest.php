<?php
namespace CiscoSystems\SalesForceBundle\ForceToolkit\Test\Soap\Mapping;

use
    CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Sobject,
    CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResultCollection
;
...
class SobjectTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSobjectAnyParent()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Sobject', $account);
    ...
    public function testSobjectRelated()
    {
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResultCollection', $sobject->get('Contacts'));
        $this->assertCount(1, $sobject->get('Contacts'));

        $contact1 = $sobject->get('Contacts')->get(0);

        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Sobject', $contact1);
    ...
    public function testSerialize()
    {
        ...
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResultCollection', $sobject->Contacts);
