<?php
namespace CiscoSystems\SalesForceBundle\ForceToolkit\Test\Soql\Parser;
...
use
    ...
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Parser\QueryParser,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Tokenizer\Tokenizer
;
...
class QueryParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSimpleSelect()
    {
        ...
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\Query', $ast);
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\SelectPart', $ast->getSelectPart());
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\FromPart', $ast->getFromPart());
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\WherePart', $ast->getWherePart());
    ...
    public function testAggregateFunctionNegative1()
    {
        ...
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Parser\ParseException', $exThrown);
    }
...
WHERE Id IN
 ...
 WHERE (Id IN (SELECT ParentId FROM Vote WHERE CreatedDate > LAST_WEEK AND Parent.Type='Idea'))");
        ...
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\QueryInterface', $ast);
        $wherePart = $ast->getQuery()->getWherePart();
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\WherePart', $wherePart);
        $logicalGroup1 = $wherePart->getLogicalGroup();
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalGroup', $logicalGroup1);
        ...
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalGroup', $logicalGroup11);
        ...
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalCondition', $logicalCondition11);
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\WhereField', $logicalCondition11->getLeft());
        $this->assertEquals('IN', $logicalCondition11->getOperator());
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\Subquery', $logicalCondition11->getRight());
