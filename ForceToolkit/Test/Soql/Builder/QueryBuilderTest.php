...
use
    ...
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Builder\QueryBuilder,
    ...
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Renderer\QueryRenderer,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Type\TypeFactory,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Builder\ExpressionBuilderInterface AS Expr
;
...
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSimpleCollectionQuery()
    {
        ...
        $this->assertInstanceOf('CiscoSystems\SalesForceBundle\Soap\Mapping\GenericResultCollection', $res);
    }

    public function testSimpleSingleSobjectQuery()
    {
        $account = new \CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Sobject('Account', array(
        ...
        $this->assertInstanceOf('\CiscoSystems\SalesForceBundle\ForceToolkit\Soap\Mapping\Sobject', $res);
