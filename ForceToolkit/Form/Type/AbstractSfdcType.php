...
abstract class AbstractSfdcType extends AbstractType implements SfdcTypeInterface
{
    ...
    /**
     * @var \CiscoSystems\SalesForceBundle\ForceToolkit\Metadata\DescribeFormFactoryInterface
     */
    protected $describeFormFactory;

    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Metadata\DescribeFormFactoryInterface $describeFormFactory
