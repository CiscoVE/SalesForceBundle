<?php
namespace CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Renderer;

use
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST AS AST,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\Functions AS Functions,
    CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Type\TypeFactory;


class QueryRenderer
{
    /**
     * @var \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Type\TypeFactory
     */
    private $typeFactory;
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\Type\TypeFactory $typeFactory
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\Query $query
     ...
     *
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\QueryInterface $query
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\SelectPart $selectPart
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\FromPart $fromPart
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\CanHazAliasInterface $alias
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\WherePart $wherePart
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\WithPart $withPart
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\GroupPart
     *
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\HavingPart
     *
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\OrderPart $orderPart
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalGroup $logicalGroup
    ...
    private function renderLogicalGroup(AST\LogicalGroup $logicalGroup)
    {
        ...
        for($i = 0; $i < $size; $i++)
        {
            ...
            /** @var $junction \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalJunction */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalConditionInterface $condition
     * @return string
     */
    private function renderCondition(AST\LogicalConditionInterface $condition)
    {
        ...
        {
            /** @var $condition \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\LogicalCondition */
            $retVal =
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\Functions\SoqlFunctionInterface $function
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\ComparableInterface $comparable
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\NamedVariable $comparable
     * @throws \RuntimeException
     * @return string
     */
    ...
    /**
     * @param \CiscoSystems\SalesForceBundle\ForceToolkit\Soql\AST\AnonymousVariable $comparable
     * @throws \RuntimeException
     * @return string
     */
